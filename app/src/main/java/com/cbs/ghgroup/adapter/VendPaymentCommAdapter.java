...
public class VendPaymentCommAdapter extends RecyclerView.Adapter<VendPaymentCommAdapter.myViewHolder>{
    List<PaymentCommunicationDetail> paymentCommunicationDetails;
    Context context;
    public VendPaymentCommAdapter(Context context, List<PaymentCommunicationDetail > paymentCommunicationDetails){
        this.paymentCommunicationDetails=paymentCommunicationDetails;
        this.context=context;
    }
    @NonNull
    @Override
    public VendPaymentCommAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull VendPaymentCommAdapter.myViewHolder holder, int position) {
        ...
        holder.tv_VendorName.setText(paymentCommunicationDetail.getCustomerName());

        if (paymentCommunicationDetail.getCustomerName().equalsIgnoreCase("Total :")) {
            holder.tv_VendorName.setVisibility(View.INVISIBLE);

            if (paymentCommunicationDetail.getTotalAmt().equalsIgnoreCase(paymentCommunicationDetail.getTotalAmt())){
