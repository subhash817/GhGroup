...
public class VendGenLedgerAdapter extends RecyclerView.Adapter<VendGenLedgerAdapter.myViewHolder> {
    ...
    public VendGenLedgerAdapter(Context context, List<LedgerDetail> customerLedgers) {
    ...
    @NonNull
    @Override
    public VendGenLedgerAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.general_ledger_item_details, parent, false);
        return new VendGenLedgerAdapter.myViewHolder(view);

    }

    @Override
    public void onBindViewHolder(VendGenLedgerAdapter.myViewHolder holder, int position) {
