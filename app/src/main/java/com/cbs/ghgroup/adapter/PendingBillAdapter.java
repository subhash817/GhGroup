...
public class PendingBillAdapter extends RecyclerView.Adapter<PendingBillAdapter.myViewHolder> {
   ...
   /* private final int TYPE_HEADER = 0;
    ...
    public PendingBillAdapter(Context context, List<PendingbillsDetail> pendingbillsDetails) {
    ...
    @NonNull
    @Override
    public PendingBillAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());

        View view = layoutInflater.inflate(R.layout.pending_bill_items, parent, false);
        return new PendingBillAdapter.myViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull PendingBillAdapter.myViewHolder holder, int position) {
        ...
        if (pendingbillsDetail.getBillAmt().equalsIgnoreCase("Total :")) {
            ...
            holder.tv_Date.setText(pendingbillsDetail.getBillAmt());
