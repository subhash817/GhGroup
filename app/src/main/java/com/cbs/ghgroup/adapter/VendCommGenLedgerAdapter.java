...
public class VendCommGenLedgerAdapter extends RecyclerView.Adapter<VendCommGenLedgerAdapter.myViewHolder> {
    ...
    public VendCommGenLedgerAdapter(Context context,List<GeneralReportDetail> generalReportDetails){
    ...
    @NonNull
    @Override
    public VendCommGenLedgerAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view= layoutInflater.inflate(R.layout.comm_genled_details, parent, false);
        return new VendCommGenLedgerAdapter.myViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VendCommGenLedgerAdapter.myViewHolder holder, int position) {
       ...
       /* if (generalReportDetail.getCustomerName().equalsIgnoreCase(generalReportDetail.getCustomerName())){
            holder.tv_VendorName.setText(generalReportDetail.getVendorName());
        } else if (generalReportDetail.getVendorName().equalsIgnoreCase(generalReportDetail.getVendorName())){
        ...
        //String data1 = "holder.tv_VoucherNumber.setText(generalReportDetail.getVoucherNumber())";
        //String data2 = "holder.tv_VendBillNo.setText(generalReportDetail.getVendorBillNo())";
