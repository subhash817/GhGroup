...
public class DirectPendingAdapter extends RecyclerView.Adapter<DirectPendingAdapter.myViewHolder> {
    List<DirectPendingDetail> directPendingDetails;
    Context context;
    public DirectPendingAdapter(Context context,List<DirectPendingDetail> directPendingDetails){
        this.directPendingDetails=directPendingDetails;
        this.context=context;
    }
    @NonNull
    @Override
    public DirectPendingAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DirectPendingAdapter.myViewHolder holder, int position) {
        ...
        holder.tv_VendorName.setText(directPendingDetail.getVendorName());
