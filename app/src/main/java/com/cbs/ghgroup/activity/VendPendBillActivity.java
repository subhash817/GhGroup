...
import com.cbs.ghgroup.adapter.VendPendBillAdapter;
import com.cbs.ghgroup.databinding.ActivityVendPendBillBinding;
...
public class VendPendBillActivity extends AppCompatActivity {
    ActivityVendPendBillBinding vendPendBillBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vendPendBillBinding = DataBindingUtil.setContentView(this,R.layout.activity_vend_pend_bill);
        overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_left);
        mContext=VendPendBillActivity.this;
    ...
    public void getId() {
        ...
        vendPendBillBinding.pendingBillPdfDownload.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                RetrofitClient.getClient1().downloadPdf(downlodLedgerRequest).enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            Toast.makeText(VendPendBillActivity.this, "Unable to download file", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        vendPendBillBinding.pendingBilExcelDownload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                RetrofitClient.getClient1().downloadExcel(excelData).enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            Toast.makeText(VendPendBillActivity.this, "Unable to download excel", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    public void getPendingBillDetails(){
        CustomProgressbar.showProgressBar(mContext, false);
        RetrofitClient.getClient().getPendingBills(upTodate,bpCode,type,branch_code,"V").enqueue(new Callback<PendingBills>() {
            @Override
            public void onResponse(Call<PendingBills> call, Response<PendingBills> response)  {
                ...
                if (response.code() ==200 && response.body() !=null){
                    ...
                    if (pendingBills.getPendingBillsResult().getPendingbillsDetail().size() > 0) {
                        ...
                        rvPendingBill = (RecyclerView) findViewById(R.id.rv_vendpen_bill_details);
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getApplicationContext());
                        rvPendingBill.setLayoutManager(linearLayoutManager);
                        VendPendBillAdapter pendingBillAdapter = new VendPendBillAdapter(VendPendBillActivity.this,pendingbillsDetails);
                        rvPendingBill.setAdapter(pendingBillAdapter);

                        try {
                            if (pendingbillsDetails.get(0).getBalance().equalsIgnoreCase(pendingbillsDetails.get(0).getBalance())){
                                vendPendBillBinding.vendPendBillsShowTotal.setText("Total:  " + pendingbillsDetails.get(0).getBalance());
                            }
