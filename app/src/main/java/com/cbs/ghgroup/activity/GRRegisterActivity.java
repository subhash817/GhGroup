...
import com.cbs.ghgroup.databinding.ActivityGRRegisterBinding;
...
public class GRRegisterActivity extends AppCompatActivity implements ItemClickListener {
    ActivityGRRegisterBinding grRegisterBinding;
    Dialog custDialog;
    ...
    AutoCompleteTextView actvGRRegCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grRegisterBinding = DataBindingUtil.setContentView(this, R.layout.activity_g_r_register);
        mContext = GRRegisterActivity.this;
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        actvGRRegCode = findViewById(R.id.edt_grRegCode);
       ...
       /* ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, customercodes);
        ...
        if ((role.equals("C"))) {
            actvGRRegCode.setText(code);
            actvGRRegCode.setEnabled(false);
            grRegisterBinding.imgGrSearchCode.setEnabled(false);
            grRegisterBinding.imgGrSearchCode.setVisibility(View.INVISIBLE);
            actvGRRegCode.setCompoundDrawables(null, null, null, null);
        }
    ...
    public void getId() {
        ...
        grRegisterBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = grRegisterBinding.tvFormDate.getText().toString();
                    String toDate = grRegisterBinding.tvToDate.getText().toString();
                    String customerCode = grRegisterBinding.edtGrRegCode.getText().toString();
                    String branch = grRegisterBinding.spinnerBranch.getSelectedItem().toString();
                    if (TextUtils.isEmpty(fromDate)) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), GeneralReportActivity.class);
                        startActivity(intent);

                    }
                }
                else {
                    CommonMethods.setSnackBar(grRegisterBinding.llLayout, getString(R.string.net));
                }


            }
        });
        grRegisterBinding.tvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        grRegisterBinding.tvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        grRegisterBinding.tvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        grRegisterBinding.tvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        grRegisterBinding.fabCustGRregLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustGRregFab();
            }
        ...
        grRegisterBinding.imgGrSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,GRRegisterActivity.this);
    ...
    public void OpenCustGRregFab(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(GRRegisterActivity.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(GRRegisterActivity.this);
        builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                grRegisterBinding.edtGrRegCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(code,cv_Code,role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    grRegisterBinding.spinnerBranch.setAdapter(adapter);
        ...
        grRegisterBinding.spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvGRRegCode.setText(customerCode);
