...
import com.cbs.ghgroup.databinding.ActivityDirectAgeingGraphBinding;
...
public class DirectAgeingGraph extends AppCompatActivity implements ItemClickListener {
    ActivityDirectAgeingGraphBinding directAgeingGraphBinding;
    Context mContext;
    Dialog custDialog;
    ...
    AutoCompleteTextView acvtDirectAgeingGraphCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        directAgeingGraphBinding = DataBindingUtil.setContentView(this,R.layout.activity_direct_ageing_graph);
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        mContext = DirectAgeingGraph.this;

        spinner_Branch = findViewById(R.id.spinner_Branch);
        acvtDirectAgeingGraphCode = findViewById(R.id.edtDirectAgeingGraphCustCode);
        ...
        if ((role.equals("C"))) {
            acvtDirectAgeingGraphCode.setText(code);
            acvtDirectAgeingGraphCode.setEnabled(false);
            directAgeingGraphBinding.imgSearchCode.setEnabled(false);
            directAgeingGraphBinding.imgSearchCode.setVisibility(View.INVISIBLE);
            acvtDirectAgeingGraphCode.setCompoundDrawables(null, null, null, null);
    ...
    public void getId(){
        ...
        directAgeingGraphBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = directAgeingGraphBinding.txtvFormDate.getText().toString();
                    String toDate = directAgeingGraphBinding.txtvToDate.getText().toString();
                    String customerCode = directAgeingGraphBinding.edtDirectAgeingGraphCustCode.getText().toString();
                    String branch = directAgeingGraphBinding.spinnerBranch.getSelectedItem().toString();
                    ...
                    if (TextUtils.isEmpty(fromDate)) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), DirectAgeingPieChart.class);
                        startActivity(intent);

                    }
                } else {
                    CommonMethods.setSnackBar(directAgeingGraphBinding.llLayout, getString(R.string.net));
                }
            }
        });

        directAgeingGraphBinding.txtvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        directAgeingGraphBinding.txtvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        directAgeingGraphBinding.txtvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        directAgeingGraphBinding.txtvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        directAgeingGraphBinding.imgSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,DirectAgeingGraph.this);
        ...
        directAgeingGraphBinding.fabDirectAgeingGraphLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustDirectBillAgeingGraphFab();
            }
        });
    }
    ...
    public void OpenCustDirectBillAgeingGraphFab() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(DirectAgeingGraph.this);
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            acvtDirectAgeingGraphCode.setText(customerCode);
