...
import com.cbs.ghgroup.databinding.ActivityBillRegisterBinding;
...
public class BillRegisterActivity extends AppCompatActivity implements ItemClickListener {
    ActivityBillRegisterBinding billRegisterBinding;
    Context mContext;
    Dialog custDialog;
    ...
    AutoCompleteTextView actvBillRegCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        billRegisterBinding = DataBindingUtil.setContentView(this, R.layout.activity_bill_register);
        mContext = BillRegisterActivity.this;
        actvBillRegCode = findViewById(R.id.edt_billRegCode);
       ...
       /* ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, customercodes);
        ...
        if ((role.equals("C"))) {
            actvBillRegCode.setText(code);
            actvBillRegCode.setEnabled(false);
            billRegisterBinding.imgBillSearchCode.setEnabled(false);
            billRegisterBinding.imgBillSearchCode.setVisibility(View.INVISIBLE);
            actvBillRegCode.setCompoundDrawables(null, null, null, null);
        }
    ...
    public void getId() {
        ...
        billRegisterBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = billRegisterBinding.tvFormDate.getText().toString();
                    String toDate = billRegisterBinding.tvToDate.getText().toString();
                    String customerCode = billRegisterBinding.edtBillRegCode.getText().toString();
                    String branch = billRegisterBinding.spinnerBranch.getSelectedItem().toString();
                    if (TextUtils.isEmpty(fromDate)) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), BillRegisterDetailsActivity.class);
                        startActivity(intent);

                    }
                }
                else {
                    CommonMethods.setSnackBar(billRegisterBinding.llLayout, getString(R.string.net));
                }
            }
        });

        billRegisterBinding.tvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        billRegisterBinding.tvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        billRegisterBinding.tvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        billRegisterBinding.tvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        billRegisterBinding.fabCustBillRegLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustBillRegFab();
            }
        ...
        billRegisterBinding.imgBillSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,BillRegisterActivity.this);
    ...
    public void OpenCustBillRegFab(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(BillRegisterActivity.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int position) {
                billRegisterBinding.edtBillRegCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(code,cv_Code,role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    billRegisterBinding.spinnerBranch.setAdapter(adapter);
        ...
        billRegisterBinding.spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvBillRegCode.setText(customerCode);
