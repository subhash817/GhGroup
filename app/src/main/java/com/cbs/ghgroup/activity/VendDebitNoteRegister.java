...
import com.cbs.ghgroup.databinding.ActivityVendDebitNoteRegisterBinding;
...
public class VendDebitNoteRegister extends AppCompatActivity implements ItemClickListener {
    ActivityVendDebitNoteRegisterBinding vendDebitNoteRegisterBinding;
    Context mContext;
    Dialog custDialog;
    ...
    AutoCompleteTextView actvVendDebitNoteCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vendDebitNoteRegisterBinding = DataBindingUtil.setContentView(this,R.layout.activity_vend_debit_note_register);

        mContext = VendDebitNoteRegister.this;
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        actvVendDebitNoteCode = findViewById(R.id.edt_vendDebitNoteCode);
        ...
        if ((Role.equals("C"))) {
            actvVendDebitNoteCode.setText(Code);
            actvVendDebitNoteCode.setEnabled(false);
            vendDebitNoteRegisterBinding.imgVendDebitSearchCode.setEnabled(false);
            vendDebitNoteRegisterBinding.imgVendDebitSearchCode.setVisibility(View.INVISIBLE);
            actvVendDebitNoteCode.setCompoundDrawables(null, null, null, null);
    ...
    public void getId() {
        ...
        vendDebitNoteRegisterBinding.tvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        vendDebitNoteRegisterBinding.tvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        vendDebitNoteRegisterBinding.tvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        vendDebitNoteRegisterBinding.tvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        vendDebitNoteRegisterBinding.btnVendDebitSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String fromDate = vendDebitNoteRegisterBinding.tvFormDate.getText().toString();
                String toDate = vendDebitNoteRegisterBinding.tvToDate.getText().toString();
                String customerCode = vendDebitNoteRegisterBinding.edtVendDebitNoteCode.getText().toString();
                String branch = vendDebitNoteRegisterBinding.spinnerVendDebitBranch.getSelectedItem().toString();
                ...
                if (TextUtils.isEmpty(fromDate)) {
                    ...
                    Intent intent = new Intent(mContext, VendDebitNoteDetailsRegister.class);
        ...
        vendDebitNoteRegisterBinding.fabVendDebitNoteRegLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                vendDebitNoteRegisterBinding();
            }
        });

        vendDebitNoteRegisterBinding.imgVendDebitSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,VendDebitNoteRegister.this);
    ...
    public void vendDebitNoteRegisterBinding() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(VendDebitNoteRegister.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(VendDebitNoteRegister.this);
        builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                vendDebitNoteRegisterBinding.edtVendDebitNoteCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(Code, CvCode, Role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    vendDebitNoteRegisterBinding.spinnerVendDebitBranch.setAdapter(adapter);
        ...
        vendDebitNoteRegisterBinding.spinnerVendDebitBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvVendDebitNoteCode.setText(customerCode);
