...
import com.cbs.ghgroup.databinding.ActivityPaymentCommunicationBinding;
...
public class PaymentCommunicationActivity extends AppCompatActivity implements ItemClickListener {
    ActivityPaymentCommunicationBinding paymentCommunBinding;
    Dialog custDialog;
    ...
    AutoCompleteTextView actvPayCommCode;
   ...
   // private static  String[] customercodes = {"C03566","C05343","C07756","C04245","C00351","C03541","C04505","C02428","C06088"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentCommunBinding = DataBindingUtil.setContentView(this, R.layout.activity_payment_communication);
        mContext = PaymentCommunicationActivity.this;
        actvPayCommCode = findViewById(R.id.edt_paymentCommCode);
        ...
        if ((role.equals("C"))) {
            actvPayCommCode.setText(code);
            actvPayCommCode.setEnabled(false);
            paymentCommunBinding.imgPayCommSearchCode.setEnabled(false);
            paymentCommunBinding.imgPayCommSearchCode.setVisibility(View.INVISIBLE);
            actvPayCommCode.setCompoundDrawables(null, null, null, null);
        }
    ...
    public void getId(){
        ...
        paymentCommunBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = paymentCommunBinding.tvFormDate.getText().toString();
                    String toDate = paymentCommunBinding.tvToDate.getText().toString();
                    String customerCode = paymentCommunBinding.edtPaymentCommCode.getText().toString();
                    String branch = paymentCommunBinding.spinnerBranch.getSelectedItem().toString();
                    if (TextUtils.isEmpty(fromDate)) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), PaymentCommDetailsActivity.class);
                ...
                {
                    CommonMethods.setSnackBar(paymentCommunBinding.llLayout, getString(R.string.net));
                }
            }
        });

        paymentCommunBinding.tvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        paymentCommunBinding.tvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        paymentCommunBinding.tvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        paymentCommunBinding.tvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        paymentCommunBinding.fabCustPayCommLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustPayCommFab();
            }
        ...
        paymentCommunBinding.imgPayCommSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,PaymentCommunicationActivity.this);
    ...
    public void OpenCustPayCommFab(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(PaymentCommunicationActivity.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PaymentCommunicationActivity.this);
        builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                paymentCommunBinding.edtPaymentCommCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(code,cv_Code,role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    paymentCommunBinding.spinnerBranch.setAdapter(adapter);
        ...
        paymentCommunBinding.spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvPayCommCode.setText(customerCode);
