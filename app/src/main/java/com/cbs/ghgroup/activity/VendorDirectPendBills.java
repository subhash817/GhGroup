...
import com.cbs.ghgroup.databinding.ActivityVendorDirectPendBillsBinding;
...
public class VendorDirectPendBills extends AppCompatActivity implements ItemClickListener {
    ActivityVendorDirectPendBillsBinding vendorDirectPendBillsBinding;
    Context mContext;
    Dialog custDialog;
    ...
    AutoCompleteTextView actvVendDirectPendBillCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vendorDirectPendBillsBinding = DataBindingUtil.setContentView(this,R.layout.activity_vendor_direct_pend_bills);
        overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_left);
        mContext=VendorDirectPendBills.this;

        actvVendDirectPendBillCode = findViewById(R.id.edt_vend_dirPendBilCode);
        ...
        if ((role.equals("C"))) {
            actvVendDirectPendBillCode.setText(code);
            actvVendDirectPendBillCode.setEnabled(false);
            vendorDirectPendBillsBinding.imgVendDirPendSearchCode.setEnabled(false);
            vendorDirectPendBillsBinding.imgVendDirPendSearchCode.setVisibility(View.INVISIBLE);
            actvVendDirectPendBillCode.setCompoundDrawables(null, null, null, null);
        }
    ...
    public void getId(){
        ...
        vendorDirectPendBillsBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = vendorDirectPendBillsBinding.txtvFormDate.getText().toString();
                    String toDate = vendorDirectPendBillsBinding.txtvToDate.getText().toString();
                    String customerCode = vendorDirectPendBillsBinding.edtVendDirPendBilCode.getText().toString();
                    String branch = vendorDirectPendBillsBinding.spinnerBranch.getSelectedItem().toString();
                    ...
                    if (TextUtils.isEmpty(toDate)) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), VendorDirectPendBillsDetails.class);
                ...
                {
                    CommonMethods.setSnackBar(vendorDirectPendBillsBinding.llLayout, getString(R.string.net));
                }
            }
        });
        vendorDirectPendBillsBinding.txtvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        vendorDirectPendBillsBinding.txtvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        vendorDirectPendBillsBinding.txtvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        vendorDirectPendBillsBinding.txtvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        vendorDirectPendBillsBinding.fabVendDirPendLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenVendDirPendFab();
            }
        ...
        vendorDirectPendBillsBinding.imgVendDirPendSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,VendorDirectPendBills.this);
               ...
               /* if (directPendingBillsBinding.edtDirPendBilCode.getText().toString().isEmpty()){
                    //Toast.makeText(GeneralLedgerActivity.this, "", Toast.LENGTH_SHORT).show();
                }else {
                    getUserList(directPendingBillsBinding.edtDirPendBilCode.getText().toString());
                }*/
            }
        });
    ...
    public void OpenVendDirPendFab(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(VendorDirectPendBills.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(VendorDirectPendBills.this);
        builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                vendorDirectPendBillsBinding.edtVendDirPendBilCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(code,cv_Code,role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    vendorDirectPendBillsBinding.spinnerBranch.setAdapter(adapter);
        ...
        vendorDirectPendBillsBinding.spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvVendDirectPendBillCode.setText(customerCode);
