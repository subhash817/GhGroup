...
import com.cbs.ghgroup.databinding.ActivityVendorBillRegBinding;
...
public class VendorBillRegActivity extends AppCompatActivity implements ItemClickListener {
    ActivityVendorBillRegBinding vendorBillRegBinding;
    Context mContext;
    Dialog custDialog;
    ...
    AutoCompleteTextView actvVendBillRegCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vendorBillRegBinding = DataBindingUtil.setContentView(this,R.layout.activity_vendor_bill_reg);
        mContext = VendorBillRegActivity.this;

        actvVendBillRegCode = findViewById(R.id.edt_vendBillRegCode);
       ...
       /* ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, customercodes);
        actvBillRegCode.setThreshold(1);
        actvBillRegCode.setAdapter(adapter);*/

        if ((role.equals("C"))) {
            actvVendBillRegCode.setText(code);
            actvVendBillRegCode.setEnabled(false);
            vendorBillRegBinding.imgVendBillSearchCode.setEnabled(false);
            vendorBillRegBinding.imgVendBillSearchCode.setVisibility(View.INVISIBLE);
            actvVendBillRegCode.setCompoundDrawables(null, null, null, null);
        }
    ...
    public void getId() {
        ...
        vendorBillRegBinding.btnVendsearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = vendorBillRegBinding.tvFormDate.getText().toString();
                    String toDate = vendorBillRegBinding.tvToDate.getText().toString();
                    String customerCode = vendorBillRegBinding.edtVendBillRegCode.getText().toString();
                    String branch = vendorBillRegBinding.spinnerVendBillBranch.getSelectedItem().toString();
                    if (TextUtils.isEmpty(fromDate)) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), VendBillDetailsActivity.class);
                        startActivity(intent);

                    }
                }
                else {
                    CommonMethods.setSnackBar(vendorBillRegBinding.llLayout, getString(R.string.net));
                }
            }
        });
        vendorBillRegBinding.tvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        vendorBillRegBinding.tvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        vendorBillRegBinding.tvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        vendorBillRegBinding.tvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        vendorBillRegBinding.fabVendBillRegLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenVendBillRegFab();
            }
        ...
        vendorBillRegBinding.imgVendBillSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,VendorBillRegActivity.this);
               ...
               /* if (billRegisterBinding.edtBillRegCode.getText().toString().isEmpty()){
                    //Toast.makeText(GeneralLedgerActivity.this, "", Toast.LENGTH_SHORT).show();
                }else {
                    getUserList(billRegisterBinding.edtBillRegCode.getText().toString());
                }*/
            }
        });
    ...
    public void OpenVendBillRegFab(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(VendorBillRegActivity.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(VendorBillRegActivity.this);
        builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                vendorBillRegBinding.edtVendBillRegCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(code,cv_Code,role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    vendorBillRegBinding.spinnerVendBillBranch.setAdapter(adapter);
        ...
        vendorBillRegBinding.spinnerVendBillBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvVendBillRegCode.setText(customerCode);
