...
import com.cbs.ghgroup.adapter.VendCommGenLedgerAdapter;
import com.cbs.ghgroup.databinding.ActivityVendorCommGenLedgerDetailsBinding;
...
public class VendorCommGenLedgerDetails extends AppCompatActivity {
    Context mContext;
    ActivityVendorCommGenLedgerDetailsBinding vendorCommGenLedgerDetailsBinding;
    RecyclerView rvcVendCommGenLedger;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vendorCommGenLedgerDetailsBinding = DataBindingUtil.setContentView(this,R.layout.activity_vendor_comm_gen_ledger_details);
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        mContext = VendorCommGenLedgerDetails.this;
        ...
        getId();
        getVendGenledDetails();
    }

    public void getVendGenledDetails() {

        CustomProgressbar.showProgressBar(mContext, false);
        RetrofitClient.getClient().getCommGenLedger(fromdate, todate, bpcode, type, branch_code,"V").enqueue(new Callback<CommGenLedger>() {
            @Override
            public void onResponse(Call<CommGenLedger> call, Response<CommGenLedger> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    if (commGenLedger.getGeneralReportResult().getGeneralReportDetail().size() > 0) {
                        ...
                        rvcVendCommGenLedger = (RecyclerView) findViewById(R.id.rv_vend_commgen_ledger_details);
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getApplicationContext());
                        rvcVendCommGenLedger.setLayoutManager(linearLayoutManager);
                        VendCommGenLedgerAdapter customAdapter = new VendCommGenLedgerAdapter(VendorCommGenLedgerDetails.this, generalReportDetails);
                        rvcVendCommGenLedger.setAdapter(customAdapter);

                        try {
                            if (generalReportDetails.get(0).getOutStanding().equalsIgnoreCase(generalReportDetails.get(0).getOutStanding())){
                                vendorCommGenLedgerDetailsBinding.vendCommGenLedgerShowTotal.setText("Total:  " + generalReportDetails.get(0).getOutStanding());
                            }
    ...
    public void getId() {
        ...
        vendorCommGenLedgerDetailsBinding.btnVendCommGenLedPdf.setOnClickListener(new View.OnClickListener() {
                ...
                RetrofitClient.getClient1().downloadPdf(downlodLedgerRequest).enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            Toast.makeText(VendorCommGenLedgerDetails.this, "Unable to download file", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        vendorCommGenLedgerDetailsBinding.btnVendCommGenLedExcel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String string = branch_code;
                String[] parts = string.split("-");
                ...
                RetrofitClient.getClient1().downloadExcel(excelData).enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.code()==200 && response.body()!=null){
                            ...
                            Toast.makeText(VendorCommGenLedgerDetails.this, "Unable to download file Excel", Toast.LENGTH_SHORT).show();
