...
import com.cbs.ghgroup.databinding.ActivityDirectPendingBillsBinding;
...
public class    DirectPendingBillsActivity extends AppCompatActivity implements ItemClickListener {
    ActivityDirectPendingBillsBinding directPendingBillsBinding;
    Context mContext;
    Dialog custDialog;
    ...
    AutoCompleteTextView actvDirectPendBillCode;
   ...
   // private static  String[] customercodes = {"C03566","C05343","C07756","C04245","C00351","C03541","C04505","C02428","C06088"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        directPendingBillsBinding = DataBindingUtil.setContentView(this, R.layout.activity_direct_pending_bills);
        overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_left);
        mContext = DirectPendingBillsActivity.this;
        actvDirectPendBillCode = findViewById(R.id.edt_dirPendBilCode);
       ...
       /* ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, customercodes);
        actvDirectPendBillCode.setThreshold(1);
        actvDirectPendBillCode.setAdapter(adapter);*/

        if ((role.equals("C"))) {
            actvDirectPendBillCode.setText(code);
            actvDirectPendBillCode.setEnabled(false);
            directPendingBillsBinding.imgDirPendSearchCode.setEnabled(false);
            directPendingBillsBinding.imgDirPendSearchCode.setVisibility(View.INVISIBLE);
            actvDirectPendBillCode.setCompoundDrawables(null, null, null, null);
        }
    ...
    public void getId(){
        ...
        directPendingBillsBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = directPendingBillsBinding.txtvFormDate.getText().toString();
                    String toDate = directPendingBillsBinding.txtvToDate.getText().toString();
                    String customerCode = directPendingBillsBinding.edtDirPendBilCode.getText().toString();
                    String branch = directPendingBillsBinding.spinnerBranch.getSelectedItem().toString();
                    /*if (TextUtils.isEmpty(fromDate)) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), DirectPenDeatilsActivity.class);
                ...
                {
                    CommonMethods.setSnackBar(directPendingBillsBinding.llLayout, getString(R.string.net));
                }
            }
        });
        directPendingBillsBinding.txtvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        directPendingBillsBinding.txtvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        directPendingBillsBinding.txtvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        directPendingBillsBinding.txtvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        directPendingBillsBinding.fabCustDirPendLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustDirPendFab();
            }
        ...
        directPendingBillsBinding.imgDirPendSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,DirectPendingBillsActivity.this);
    ...
    public void OpenCustDirPendFab(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(DirectPendingBillsActivity.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DirectPendingBillsActivity.this);
        builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                directPendingBillsBinding.edtDirPendBilCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(code,cv_Code,role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    directPendingBillsBinding.spinnerBranch.setAdapter(adapter);
        ...
        directPendingBillsBinding.spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvDirectPendBillCode.setText(customerCode);
