...
import com.cbs.ghgroup.databinding.ActivityPurchaseRegisterBinding;
...
public class PurchaseRegisterActivity extends AppCompatActivity implements ItemClickListener {
    Context mContext;
    Dialog custDialog;
    UserListAdapter userListAdapter;
    ActivityPurchaseRegisterBinding PurchaseRegisterBinding;
    ...
    AutoCompleteTextView actvPurCustCode;
   ...
   // private static  String[] customercodes = {"C03566","C05343","C07756","C04245","C00351","C03541","C04505","C02428","C06088"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PurchaseRegisterBinding = DataBindingUtil.setContentView(this, R.layout.activity_purchase_register);
        mContext = PurchaseRegisterActivity.this;
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        actvPurCustCode = findViewById(R.id.edt_purchaseCustCode);
        ...
        actvPurCustCode.setThreshold(1);
        actvPurCustCode.setAdapter(adapter);*/

        if ((Role.equals("C"))) {
            actvPurCustCode.setText(Code);
            actvPurCustCode.setEnabled(false);
            PurchaseRegisterBinding.imgPurchaseSearchCode.setEnabled(false);
            PurchaseRegisterBinding.imgPurchaseSearchCode.setVisibility(View.INVISIBLE);
            actvPurCustCode.setCompoundDrawables(null, null, null, null);
        }
    ...
    public void getId() {
        ...
        PurchaseRegisterBinding.tvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        PurchaseRegisterBinding.tvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        PurchaseRegisterBinding.tvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        PurchaseRegisterBinding.tvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        PurchaseRegisterBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (CommonMethods.isOnline(mContext)) {

                    String fromDate = PurchaseRegisterBinding.tvFormDate.getText().toString();
                    String toDate = PurchaseRegisterBinding.tvToDate.getText().toString();
                    String customerCode = PurchaseRegisterBinding.edtPurchaseCustCode.getText().toString();
                    String branch = PurchaseRegisterBinding.spinnerBranch.getSelectedItem().toString();
                    if (TextUtils.isEmpty(fromDate)) {
                        ...
                        Intent intent = new Intent(mContext, PurchesRegisterDeatilsActivity.class);
                        startActivity(intent);

                    }
                } else {
                    CommonMethods.setSnackBar(PurchaseRegisterBinding.llLayout, getString(R.string.net));
                }
            }
        });
        ...
        PurchaseRegisterBinding.fabCustPurRegLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustPurRegFab();
            }
        ...
        PurchaseRegisterBinding.imgPurchaseSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,PurchaseRegisterActivity.this);
                ...
                /*if (PurchaseRegisterBinding.edtPurchaseCustCode.getText().toString().isEmpty()){
                    //Toast.makeText(GeneralLedgerActivity.this, "", Toast.LENGTH_SHORT).show();
                }else {
                    getUserList(PurchaseRegisterBinding.edtPurchaseCustCode.getText().toString());
                }*/
            }
        });
    ...
    public void OpenCustPurRegFab(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(PurchaseRegisterActivity.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PurchaseRegisterActivity.this);
       // builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                PurchaseRegisterBinding.edtPurchaseCustCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(Code, CvCode, Role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    PurchaseRegisterBinding.spinnerBranch.setAdapter(adapter);
        ...
        PurchaseRegisterBinding.spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvPurCustCode.setText(customerCode);
