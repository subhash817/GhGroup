...
import com.cbs.ghgroup.databinding.ActivityVendGeneralLedgerBinding;
...
public class VendGeneralLedgerActivity extends AppCompatActivity implements ItemClickListener {
    Context mContext;
    Dialog custDialog;
    UserListAdapter userListAdapter;
    public int mYear, mMonth, mDay;
    SimpleDateFormat sdf;
    ActivityVendGeneralLedgerBinding vendGeneralLedgerBinding;
    ...
    AutoCompleteTextView actvGenLedCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vendGeneralLedgerBinding = DataBindingUtil.setContentView(this,R.layout.activity_vend_general_ledger);
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        mContext = VendGeneralLedgerActivity.this;

        spinner_Branch = findViewById(R.id.spinner_vendGenLed_Branch);
        actvGenLedCode = findViewById(R.id.edtvendGeneraledCode);
        ...
        if ((role.equals("C"))) {
            actvGenLedCode.setText(code);
            actvGenLedCode.setEnabled(false);
            vendGeneralLedgerBinding.imgVendSearchCode.setEnabled(false);
            vendGeneralLedgerBinding.imgVendSearchCode.setVisibility(View.INVISIBLE);
            actvGenLedCode.setCompoundDrawables(null, null, null, null);
    ...
    public void getId() {
        ...
        vendGeneralLedgerBinding.btnVenGenLedSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //svSearch.setVisibility(View.VISIBLE);
                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = vendGeneralLedgerBinding.txtvFormDate.getText().toString();
                    String toDate = vendGeneralLedgerBinding.txtvToDate.getText().toString();
                    String customerCode = vendGeneralLedgerBinding.edtvendGeneraledCode.getText().toString();
                    String branch = vendGeneralLedgerBinding.spinnerVendGenLedBranch.getSelectedItem().toString();
                    ...
                    if (TextUtils.isEmpty(fromDate)) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), VendPdfActivity.class);
                        startActivity(intent);

                    }
                } else {
                    CommonMethods.setSnackBar(vendGeneralLedgerBinding.llLayout, getString(R.string.net));
                }
        ...
        vendGeneralLedgerBinding.txtvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        vendGeneralLedgerBinding.txtvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        vendGeneralLedgerBinding.txtvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        vendGeneralLedgerBinding.txtvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        vendGeneralLedgerBinding.fabVendorGenLedLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenVendorGenLedFab();
            }
        ...
        vendGeneralLedgerBinding.imgVendSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,VendGeneralLedgerActivity.this);
    ...
    public void OpenVendorGenLedFab() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(VendGeneralLedgerActivity.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(VendGeneralLedgerActivity.this);
        // builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                vendGeneralLedgerBinding.edtvendGeneraledCode.setText(userCode.get(position));
                // generalLedgerBinding.edtGeneralCustCode.setSelection(generalLedgerBinding.edtGeneralCustCode.getText().length());
            }
        });
        builder.show();
    }
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvGenLedCode.setText(customerCode);
