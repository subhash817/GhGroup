...
import com.cbs.ghgroup.databinding.ActivityGhAgeingGraphBinding;
...
public class GhAgeingGraph extends AppCompatActivity implements ItemClickListener {
    ActivityGhAgeingGraphBinding ghAgeingGraphBinding;
    Context mContext;
    Dialog custDialog;
    ...
    AutoCompleteTextView acvtGhBillingAgeingGraphCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ghAgeingGraphBinding = DataBindingUtil.setContentView(this,R.layout.activity_gh_ageing_graph);
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        mContext = GhAgeingGraph.this;

        spinner_Branch = findViewById(R.id.spinner_Branch);
        acvtGhBillingAgeingGraphCode = findViewById(R.id.edtGhBillGraphCustCode);
        ...
        if ((role.equals("C"))) {
            acvtGhBillingAgeingGraphCode.setText(code);
            acvtGhBillingAgeingGraphCode.setEnabled(false);
            ghAgeingGraphBinding.imgSearchCode.setEnabled(false);
            ghAgeingGraphBinding.imgSearchCode.setVisibility(View.INVISIBLE);
            acvtGhBillingAgeingGraphCode.setCompoundDrawables(null, null, null, null);
    ...
    public void getId(){
        ...
        ghAgeingGraphBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = ghAgeingGraphBinding.txtvFormDate.getText().toString();
                    String toDate = ghAgeingGraphBinding.txtvToDate.getText().toString();
                    String customerCode = ghAgeingGraphBinding.edtGhAgeingGraphCustCode.getText().toString();
                    String branch = ghAgeingGraphBinding.spinnerBranch.getSelectedItem().toString();
                    ...
                    Intent intent = new Intent(getApplicationContext(), GhAgeingPieChart.class);
                    startActivity(intent);

                     }
                } else {
                    CommonMethods.setSnackBar(ghAgeingGraphBinding.llLayout, getString(R.string.net));
                }
            }
        });

        ghAgeingGraphBinding.txtvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        ghAgeingGraphBinding.txtvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        ghAgeingGraphBinding.txtvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        ghAgeingGraphBinding.txtvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        ghAgeingGraphBinding.imgSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,GhAgeingGraph.this);
        ...
        ghAgeingGraphBinding.fabGhAgeingGraphLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustGhBillAgeingGraphFab();
            }
        });
    }
    ...
    public void OpenCustGhBillAgeingGraphFab() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(GhAgeingGraph.this);
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            acvtGhBillingAgeingGraphCode.setText(customerCode);
