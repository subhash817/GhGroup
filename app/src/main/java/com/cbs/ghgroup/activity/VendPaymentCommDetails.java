...
import com.cbs.ghgroup.adapter.VendPaymentCommAdapter;
import com.cbs.ghgroup.databinding.ActivityVendPaymentCommDetailsBinding;
...
public class VendPaymentCommDetails extends AppCompatActivity {
    ActivityVendPaymentCommDetailsBinding vendPaymentCommDetailsBinding;
    Context mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vendPaymentCommDetailsBinding = DataBindingUtil.setContentView(this,R.layout.activity_vend_payment_comm_details);
        mContext = VendPaymentCommDetails.this;
    ...
    public void getId(){
        ...
        RetrofitClient.getClient().getPaymentCommunication(fromDate,toDate,code,branch_code,"V").enqueue(new Callback<PaymentCommunication>() {
            @Override
            public void onResponse(Call<PaymentCommunication> call, Response<PaymentCommunication> response) {
                ...
                if (response.code() ==200 && response.body() !=null){
                    ...
                    if (paymentCommunication.getPaymentCommunicationResult().getPaymentCommunicationDetail().size() > 0) {
                        ...
                        Log.e("TAG", "Request: " + response.toString());
                        rvPaymentComm = (RecyclerView) findViewById(R.id.rcv_vend_paymentCommRegister);
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getApplicationContext());
                        vendPaymentCommDetailsBinding.rcvVendPaymentCommRegister.setLayoutManager(linearLayoutManager);
                        VendPaymentCommAdapter paymentCommunicationAdapter = new VendPaymentCommAdapter(VendPaymentCommDetails.this,paymentCommunicationDetails);
                        vendPaymentCommDetailsBinding.rcvVendPaymentCommRegister.setAdapter(paymentCommunicationAdapter);

//                        int vendPayCommTotal = 0;
//
...
//                            vendPayCommTotal = vendPayCommTotal+totalamt;
//                            DecimalFormat formatter = new DecimalFormat("##,##,##,##,###");
//                            vendPaymentCommDetailsBinding.vendPayCommRegShowTotal.setText("Total:  " +formatter.format(vendPayCommTotal));
//
//                            //tv.setText(""+bill);
//                        }

                        //    total data get from service
                        ...
                        try {
                            ...
                            for (int i = 0; i < paymentCommunicationDetails.size(); i++) {
                                ...
                                fileName = paymentCommunicationDetails.get(i).getTotalAmt();
                                if (paymentCommunicationDetails.get(i).getCustomerName() != "Total :") {
//                                    DecimalFormat formatter = new DecimalFormat("##,##,##,##,###");
                                    //paymentCommDetailsBinding.payCommShowTotal.setText("Total:  " +formatter.format(paybill));
                                    vendPaymentCommDetailsBinding.vendPayCommRegShowTotal.setText(fileName);
                                    ...
                                    DecimalFormat formatter = new DecimalFormat("##,##,##,##,###");
                                    //paymentCommDetailsBinding.payCommShowTotal.setText("Total:  " +formatter.format(paybill));
                                    vendPaymentCommDetailsBinding.vendPayCommRegShowTotal.setText("Total:  " + formatter.format(paybill));
                                }
                            }
        ...
        vendPaymentCommDetailsBinding.paymentCommExcelDownload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                RetrofitClient.getClient1().downloadExcel(excelData).enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            Toast.makeText(VendPaymentCommDetails.this, "Unable to download excel", Toast.LENGTH_SHORT).show();
                        }
                    }
