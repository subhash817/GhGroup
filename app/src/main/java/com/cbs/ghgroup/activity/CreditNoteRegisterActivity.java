...
import com.cbs.ghgroup.databinding.ActivityCreditNoteRegisterBinding;
...
public class CreditNoteRegisterActivity extends AppCompatActivity implements ItemClickListener {
    Context mContext;
    Dialog custDialog;
    UserListAdapter userListAdapter;
    ActivityCreditNoteRegisterBinding creditNoteRegisterBinding;
    ...
    AutoCompleteTextView actvCreditNoteCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        creditNoteRegisterBinding = DataBindingUtil.setContentView(this, R.layout.activity_credit_note_register);
        mContext = CreditNoteRegisterActivity.this;
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        actvCreditNoteCode = findViewById(R.id.edt_creditNoteCode);
        ...
        if ((Role.equals("C"))) {
            actvCreditNoteCode.setText(Code);
            actvCreditNoteCode.setEnabled(false);
            creditNoteRegisterBinding.imgCreditSearchCode.setEnabled(false);
            creditNoteRegisterBinding.imgCreditSearchCode.setVisibility(View.INVISIBLE);
            actvCreditNoteCode.setCompoundDrawables(null, null, null, null);
    ...
    public void getId() {
        ...
        creditNoteRegisterBinding.tvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        creditNoteRegisterBinding.tvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        creditNoteRegisterBinding.tvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        creditNoteRegisterBinding.tvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        creditNoteRegisterBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String fromDate = creditNoteRegisterBinding.tvFormDate.getText().toString();
                String toDate = creditNoteRegisterBinding.tvToDate.getText().toString();
                String customerCode = creditNoteRegisterBinding.edtCreditNoteCode.getText().toString();
                String branch = creditNoteRegisterBinding.spinnerBranch.getSelectedItem().toString();
                ...
                if (TextUtils.isEmpty(fromDate)) {
                    ...
                    Intent intent = new Intent(mContext, CreditRegisterDetailsActivity.class);
        ...
        creditNoteRegisterBinding.fabCustCreditNoteRegLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustCreditNoteRegFab();
            }
        });

        creditNoteRegisterBinding.imgCreditSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,CreditNoteRegisterActivity.this);
               ...
               // getUserList();
                ...
                /*if (creditNoteRegisterBinding.edtCreditNoteCode.getText().toString().isEmpty()){
                    //Toast.makeText(GeneralLedgerActivity.this, "", Toast.LENGTH_SHORT).show();
                }else {
                    getUserList(creditNoteRegisterBinding.edtCreditNoteCode.getText().toString());
                }*/
            }
        });
    ...
    public void OpenCustCreditNoteRegFab() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(CreditNoteRegisterActivity.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(CreditNoteRegisterActivity.this);
        builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                creditNoteRegisterBinding.edtCreditNoteCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(Code, CvCode, Role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    creditNoteRegisterBinding.spinnerBranch.setAdapter(adapter);
        ...
        creditNoteRegisterBinding.spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvCreditNoteCode.setText(customerCode);
