...
import com.cbs.ghgroup.adapter.GenLedgerAdapter;
import com.cbs.ghgroup.databinding.ActivityPdfBinding;
...
public class PdfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdfBinding = DataBindingUtil.setContentView(this, R.layout.activity_pdf);
    ...
    public void getGenledDetails() {
        ...
        RetrofitClient.getClient().getCustomerLedger(fromdate, todate, bpcode, type, branch_code,"C").enqueue(new Callback<CustomerLedger2>() {
            @Override
            public void onResponse(Call<CustomerLedger2> call, Response<CustomerLedger2> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    response.body().getCustomerLedger2Result().getLogMessage().getErrorMsg();
                    ...
                    if (customerLedger.getCustomerLedger2Result().getLedgerDetail().size() > 0) {
                        ...
                        GenLedgerAdapter customAdapter = new GenLedgerAdapter(PdfActivity.this, ledgerDetails);
                        ...
                        try {
                            if (ledgerDetails.get(0).getOutStanding().equalsIgnoreCase(ledgerDetails.get(0).getOutStanding())){
                                pdfBinding.genLedgerShowTotal.setText("Total:  " + ledgerDetails.get(0).getOutStanding());
                            }
                        ...
                        for (int i = 0;i<ledgerDetails.size();i++){
                            String abc = ledgerDetails.get(i).getAmount().replaceAll(",","");
                            int billamt = Integer.parseInt(abc);
                            bill = bill+billamt;
                            pdfBinding.genLedgerShowTotal.setText("Total:  " +bill);

                            //genLedgerShowTotal.setText("Total:  " +bill);
    ...
    public void getId() {
        ...
        TextView genLedgerShowTotal = findViewById(R.id.genLedger_showTotal);
        ...
        pdfBinding.PDFDOWNLOD.setOnClickListener(new View.OnClickListener() {
                ...
                RetrofitClient.getClient1().downloadPdf(downlodLedgerRequest).enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            Toast.makeText(PdfActivity.this, "Unable to download file", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        pdfBinding.btnGenLedExcel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String string = branch_code;
                String[] parts = string.split("-");
                ...
                RetrofitClient.getClient1().downloadExcel(excelData).enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.code()==200 && response.body()!=null){
                            ...
                            Toast.makeText(PdfActivity.this, "Unable to download file Excel", Toast.LENGTH_SHORT).show();
