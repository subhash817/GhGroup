...
import com.cbs.ghgroup.databinding.ActivityVendSaleRegisterBinding;
...
public class VendSaleRegister extends AppCompatActivity implements ItemClickListener {
    ActivityVendSaleRegisterBinding vendSaleRegisterBinding;
    Context mContext;
    Dialog custDialog;
    ...
    AutoCompleteTextView actvVendSaleCode;
    String codeData,customerCode;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        vendSaleRegisterBinding = DataBindingUtil.setContentView(this,R.layout.activity_vend_sale_register);

        mContext = VendSaleRegister.this;
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        actvVendSaleCode = findViewById(R.id.edt_vendSaleCode);
        ...
        if ((Role.equals("C"))) {
            actvVendSaleCode.setText(Code);
            actvVendSaleCode.setEnabled(false);
            vendSaleRegisterBinding.imgVendSaleSearchCode.setEnabled(false);
            vendSaleRegisterBinding.imgVendSaleSearchCode.setVisibility(View.INVISIBLE);
            actvVendSaleCode.setCompoundDrawables(null, null, null, null);
        }
    ...
    public void getId() {
        ...
        vendSaleRegisterBinding.tvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        vendSaleRegisterBinding.tvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        vendSaleRegisterBinding.tvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        vendSaleRegisterBinding.tvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        vendSaleRegisterBinding.btnVendSaleSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (CommonMethods.isOnline(mContext)) {

                    String fromDate = vendSaleRegisterBinding.tvFormDate.getText().toString();
                    String toDate = vendSaleRegisterBinding.tvToDate.getText().toString();
                    String customerCode = vendSaleRegisterBinding.edtVendSaleCode.getText().toString();
                    String branch = vendSaleRegisterBinding.spinnerVendSaleBranch.getSelectedItem().toString();
                    if (TextUtils.isEmpty(fromDate)) {
                        ...
                        Intent intent = new Intent(mContext, VendSaleRegDetails.class);
                        startActivity(intent);

                    }
                } else {
                    CommonMethods.setSnackBar(vendSaleRegisterBinding.llLayout, getString(R.string.net));
                }
            }
        });
        ...
        vendSaleRegisterBinding.fabVendSaleRegLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenVendSalerRegFab();
            }
        ...
        vendSaleRegisterBinding.imgVendSaleSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,VendSaleRegister.this);
    ...
    public void OpenVendSalerRegFab(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(VendSaleRegister.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(VendSaleRegister.this);
        // builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                vendSaleRegisterBinding.edtVendSaleCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(Code, CvCode, Role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    vendSaleRegisterBinding.spinnerVendSaleBranch.setAdapter(adapter);
        ...
        vendSaleRegisterBinding.spinnerVendSaleBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvVendSaleCode.setText(customerCode);
