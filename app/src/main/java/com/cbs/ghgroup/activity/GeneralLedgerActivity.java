...
import com.cbs.ghgroup.databinding.ActivityGeneralLedgerBinding;
...
public class GeneralLedgerActivity extends AppCompatActivity implements ItemClickListener {
    Dialog custDialog;
    UserListAdapter userListAdapter;
    Context mContext;
    public int mYear, mMonth, mDay;
    SimpleDateFormat sdf;
    ActivityGeneralLedgerBinding generalLedgerBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generalLedgerBinding = DataBindingUtil.setContentView(this, R.layout.activity_general_ledger);
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        mContext = GeneralLedgerActivity.this;
        ...
        if ((role.equals("C"))) {
            ...
            generalLedgerBinding.imgSearchCode.setEnabled(false);
            generalLedgerBinding.imgSearchCode.setVisibility(View.INVISIBLE);
    ...
    public void getId() {
        ...
        generalLedgerBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //svSearch.setVisibility(View.VISIBLE);
                if (CommonMethods.isOnline(mContext)) {
                    CommonMethods.hideKeyboard(mContext);
                    String fromDate = generalLedgerBinding.txtvFormDate.getText().toString();
                    String toDate = generalLedgerBinding.txtvToDate.getText().toString();
                    String customerCode = generalLedgerBinding.edtGeneralCustCode.getText().toString();
                    String branch = generalLedgerBinding.spinnerBranch.getSelectedItem().toString();
                    ...
                    CommonMethods.setSnackBar(generalLedgerBinding.llLayout, getString(R.string.net));
                }
        ...
        generalLedgerBinding.txtvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        generalLedgerBinding.txtvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        generalLedgerBinding.txtvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        generalLedgerBinding.txtvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        generalLedgerBinding.fabCustGenLedLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustGenLedFab();
            }
        ...
        generalLedgerBinding.imgSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,GeneralLedgerActivity.this);
    ...
    public void OpenCustGenLedFab() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(GeneralLedgerActivity.this);
    ...
    private void getDataOnPopup() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(GeneralLedgerActivity.this);

        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                generalLedgerBinding.edtGeneralCustCode.setText(userCode.get(position));
