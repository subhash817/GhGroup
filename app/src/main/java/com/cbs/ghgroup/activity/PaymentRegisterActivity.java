...
import com.cbs.ghgroup.databinding.ActivityPaymentRegisterBinding;
...
public class PaymentRegisterActivity extends AppCompatActivity implements ItemClickListener {
    Dialog custDialog;
    UserListAdapter userListAdapter;
    Context mContext;
    ActivityPaymentRegisterBinding paymentRegisterBinding;
    ...
    AutoCompleteTextView actvPaymentRegCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentRegisterBinding = DataBindingUtil.setContentView(this, R.layout.activity_payment_register);
        mContext = PaymentRegisterActivity.this;
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
        actvPaymentRegCode = findViewById(R.id.edt_paymentRegCode);
       ...
       /* ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, customercodes);
        actvPaymentRegCode.setThreshold(1);
        actvPaymentRegCode.setAdapter(adapter);*/

        if ((Role.equals("C"))) {
            actvPaymentRegCode.setText(Code);
            actvPaymentRegCode.setEnabled(false);
            paymentRegisterBinding.imgPaymentSearchCode.setEnabled(false);
            paymentRegisterBinding.imgPaymentSearchCode.setVisibility(View.INVISIBLE);
            actvPaymentRegCode.setCompoundDrawables(null, null, null, null);
        }
    ...
    public void getId() {
        ...
        paymentRegisterBinding.tvFormDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        paymentRegisterBinding.tvFormDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
        ...
        paymentRegisterBinding.tvToDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar mcurrentDate = Calendar.getInstance();
                mYear = mcurrentDate.get(Calendar.YEAR);
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        c.set(selectedyear, selectedmonth, selectedday);
                        sdf = new SimpleDateFormat("dd/MM/yyyy");
                        paymentRegisterBinding.tvToDate.setText(CommonMethods.pad(selectedday) + "/" + CommonMethods.pad(selectedmonth + 1) +
                                "/" + CommonMethods.pad(selectedyear));
                    }
                }, mYear, mMonth, mDay);
                mDatePicker.getDatePicker().setCalendarViewShown(false);
        ...
        paymentRegisterBinding.btnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (CommonMethods.isOnline(mContext)) {

                    String fromDate = paymentRegisterBinding.tvFormDate.getText().toString();
                    String toDate = paymentRegisterBinding.tvToDate.getText().toString();
                    String customerCode = paymentRegisterBinding.edtPaymentRegCode.getText().toString();
                    String branch = paymentRegisterBinding.spinnerBranch.getSelectedItem().toString();
                    ...
                    else
                    {
                        ...
                        Intent intent = new Intent(mContext, PaymentRegisterDetailsActivity.class);
                ...
                {
                    CommonMethods.setSnackBar(paymentRegisterBinding.llLayout, getString(R.string.net));
        ...
        paymentRegisterBinding.fabCustPayRegLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OpenCustPayRegFab();
            }
        ...
        paymentRegisterBinding.imgPaymentSearchCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    ...
                    public void onResponse(Call<UsersList> call, Response<UsersList> response) {
                        ...
                        if (response.code() == 200 && response.body() != null) {
                            ...
                            for (int i = 0; i < usersDetails.size(); i++) {
                                ...
                                userListAdapter = new UserListAdapter(mContext, usersDetails,PaymentRegisterActivity.this);
                ...
                /*if (paymentRegisterBinding.edtPaymentRegCode.getText().toString().isEmpty()){
                    //Toast.makeText(GeneralLedgerActivity.this, "", Toast.LENGTH_SHORT).show();
                }else {
                    getUserList(paymentRegisterBinding.edtPaymentRegCode.getText().toString());
                }*/
            }
        });
    ...
    public void OpenCustPayRegFab(){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(PaymentRegisterActivity.this);
...
//                        user_name = userName.toString();
    ...
    private void getDataOnPopup(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PaymentRegisterActivity.this);
        builder.setTitle("");
        builder.setItems(contract, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int position) {
                paymentRegisterBinding.edtPaymentRegCode.setText(userCode.get(position));
            }
        });
        builder.show();
    }
    ...
    public void getBranchList() {
        RetrofitClient.getClient().getBranchList(Code, CvCode, Role).enqueue(new Callback<BranchList>() {
            ...
            public void onResponse(Call<BranchList> call, Response<BranchList> response) {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    paymentRegisterBinding.spinnerBranch.setAdapter(adapter);
        ...
        paymentRegisterBinding.spinnerBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void onClick(String customerCode) {
        ...
        if (custDialog != null) {
            actvPaymentRegCode.setText(customerCode);
